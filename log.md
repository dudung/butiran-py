...
`url` <https://pypi.org/project/butiran/0.0.9/>
...
### Test it using `vect3_tests.py`
```
$ py tests\vect3_tests.py
a = (0, 0, 0)
```
...
Enter your password:
Uploading butiran-0.0.9-py3-none-any.whl
100%|██████████████████████████████████████████████| 9.31k/9.31k [00:03<00:00, 2.47kB/s]
Uploading butiran-0.0.9.tar.gz
100%|██████████████████████████████████████████████| 8.51k/8.51k [00:02<00:00, 4.21kB/s]

View at:
https://pypi.org/project/butiran/0.0.9/
```

### Before install from PyPI
```
$ py tests\vect3_tests.py
Traceback (most recent call last):
  File "L:\home\butiran-py\tests\vect3_tests.py", line 22, in <module>
...
### Install from PyPI
```
py -m pip install butiran
Collecting butiran
  Downloading butiran-0.0.9-py3-none-any.whl (5.1 kB)
Installing collected packages: butiran
Successfully installed butiran-0.0.9
```
